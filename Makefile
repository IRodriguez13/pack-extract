...
PACK_FILES = VERSION COPYING Makefile README.md CONTRIBUTORS.md Documentation PKGBUILD aur src include man completions debian install.sh scripts/verify-c-install.sh scripts/install-from-bin-tarball.sh tests .gitignore
